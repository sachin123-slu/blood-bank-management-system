...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Facebook, name: "Facebook", url: "https://www.facebook.com/sachin.kumar.sluriya" },
    { icon: Instagram, name: "Instagram", url: "https://www.instagram.com/sluriya123/" },
    { icon: Linkedin, name: "LinkedIn", url: "https://www.linkedin.com/in/sachin-kumar-108634300/" },
  ];
